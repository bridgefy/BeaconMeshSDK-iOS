...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/FranciscoMkdir/BeaconMeshSDK-iOS-binary/releases/download/1.0.4/BeaconMeshFramework.xcframework.zip",
            checksum: "fc1f6322563699a199189cde0a2959cfd911452fd1b0b9f567a22ecb98f1240f"
        ),
