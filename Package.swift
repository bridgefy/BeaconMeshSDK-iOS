...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/FranciscoMkdir/BeaconMeshSDK-iOS-binary/releases/download/1.0.4/BeaconMesh.xcframework.zip",
            checksum: "db340731941091a69ea89c63d52078ea6dbba88c3f82a54185e65ad86afc4b36"
        ),
